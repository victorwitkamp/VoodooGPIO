 ...
 * @is_offset: Register offset of GPI_IS from @regs. If %0 then the
 *             legacy %GPI_IS offset (0x100) is assumed.
...
class VoodooGPIOIntel : public VoodooGPIO {
    OSDeclareDefaultStructors(VoodooGPIOIntel);
...
protected:
 ...
 public:
    ...
    IOReturn setInterruptTypeForPin(int pin, int type) override;
